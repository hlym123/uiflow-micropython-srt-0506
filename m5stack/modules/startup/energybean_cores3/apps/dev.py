...
class DevApp(app_base.AppBase):
    ...
    def on_install(self):
        M5.Lcd.drawImage(
            "/system/energybean_cores3/Selection/develop_unselected.png", 5 + 62, 20 + 4
        )
    ...
    def on_view(self):
        M5.Lcd.drawImage("/system/energybean_cores3/Selection/develop_selected.png", 5 + 62, 20 + 4)
        self._origin_x = 0
        self._origin_y = 80
        self._lcd.clear()
    ...
    def _get_bg_src(self):
        if _HAS_SERVER is True and M5Things.status() == 2:
            infos = M5Things.info()
            if infos[0] == 0:
                return "/system/energybean_cores3/Develop/private.png"
            elif infos[0] in (1, 2):
                return "/system/energybean_cores3/Develop/public.png"
        else:
            return "/system/energybean_cores3/Develop/private.png"
