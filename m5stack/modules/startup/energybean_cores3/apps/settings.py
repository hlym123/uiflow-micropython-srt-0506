...
class WiFiSetting(app_base.AppBase):
    ...
    def on_view(self):
        ...
        self._bg_img.set_src("/system/energybean_cores3/Setting/wifiServer.png")
    ...
    def _select_ssid_option(self):
        self._bg_img.set_src("/system/energybean_cores3/Setting/ssid.png")
    ...
    def _select_psk_option(self):
        self._bg_img.set_src("/system/energybean_cores3/Setting/pass.png")
        self._ssid_label.set_text_color(0x000000, 0xFEFEFE)
    ...
    def _select_server_option(self):
        self._bg_img.set_src("/system/energybean_cores3/Setting/server.png")
        self._ssid_label.set_text_color(0x000000, 0xFEFEFE)
        self._psk_label.set_text_color(0x000000, 0xFEFEFE)
...
_current_options = {
    100: "/system/energybean_cores3/Setting/charge100.png",
    500: "/system/energybean_cores3/Setting/charge500.png",
    900: "/system/energybean_cores3/Setting/charge900.png",
    1000: "/system/energybean_cores3/Setting/charge1000.png",
}
...
_boot_options = {
    1: "/system/energybean_cores3/Setting/bootYes.png",
    2: "/system/energybean_cores3/Setting/bootNo.png",
}
...
_comlink_options = {
    False: "/system/energybean_cores3/Setting/comxDisable.png",
    True: "/system/energybean_cores3/Setting/comxEnable.png",
}
...
_usbpower_options = {
    False: "/system/energybean_cores3/Setting/usbInput.png",
    True: "/system/energybean_cores3/Setting/usbOutput.png",
}
...
_buspower_options = {
    False: "/system/energybean_cores3/Setting/busInput.png",
    True: "/system/energybean_cores3/Setting/busOutput.png",
}
...
class SettingsApp(app_base.AppBase):
    ...
    def on_install(self):
        M5.Lcd.drawImage(
            "/system/energybean_cores3/Selection/setting_unselected.png", 5 + 62 * 0, 20 + 4
        )
    ...
    def on_view(self):
        ...
        self._origin_y = 80
        M5.Lcd.drawImage(
            "/system/energybean_cores3/Selection/setting_selected.png", 5 + 62 * 0, 20 + 4
        )
        self._lcd.clear()
