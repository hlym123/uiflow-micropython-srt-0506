...
class ListApp(app_base.AppBase):
    ...
    def on_install(self):
        list_tab_x = 193
        M5.Lcd.drawImage(
            "/system/energybean_cores3/Selection/appList_unselected.png", list_tab_x, 20 + 4
        )
        self.descriptor = app_base.Descriptor(x=list_tab_x, y=20 + 4, w=62, h=56)
    ...
    def on_view(self):
        list_tab_x = 193
        M5.Lcd.drawImage(
            "/system/energybean_cores3/Selection/appList_selected.png", list_tab_x, 20 + 4
        )

        self._bg_img = widgets.Image(use_sprite=False)
        self._bg_img.set_pos(4, 20 + 4 + 56 + 4)
        self._bg_img.set_size(312, 156)
        self._bg_img.set_src("/system/energybean_cores3/List/main.png")
        ...
        self._left_img.set_src("/system/energybean_cores3/List/left_cursor.png")
        ...
        self._right_img.set_src("/system/energybean_cores3/List/right_cursor.png")
