...
_WIFI_STATUS_ICO = {
    NetworkStatus.INIT: "/system/energybean_cores3/WiFi/wifi_empty.png",
    NetworkStatus.RSSI_GOOD: "/system/energybean_cores3/WiFi/wifi_good.png",
    NetworkStatus.RSSI_MID: "/system/energybean_cores3/WiFi/wifi_mid.png",
    NetworkStatus.RSSI_WORSE: "/system/energybean_cores3/WiFi/wifi_worse.png",
    NetworkStatus.DISCONNECTED: "/system/energybean_cores3/WiFi/wifi_disconnected.png",
}

_CLOUD_STATUS_ICOS = {
    CloudStatus.INIT: "/system/energybean_cores3/Server/server_empty.png",
    CloudStatus.CONNECTED: "/system/energybean_cores3/Server/Server_Green.png",
    CloudStatus.DISCONNECTED: "/system/energybean_cores3/Server/server_error.png",
}
...
class StatusBarApp(app_base.AppBase):
    ...
    def on_view(self):
        M5.Lcd.drawImage("/system/energybean_cores3/Title/title_blue.png", 0, 0)
        # Mask the left title icon area in the background asset.
        M5.Lcd.fillRect(0, 0, 100, 20, 0xEEEEEF)
    ...
    def _get_battery_src(self, battery, charging):
        ...
        if battery > 0 and battery <= 100:
            if battery < 20:
                src = (
                    "/system/energybean_cores3/Battery/battery_Red_Charge.png"
                    if charging
                    else "/system/energybean_cores3/Battery/battery_Red.png"
                )
            elif battery <= 100:
                src = (
                    "/system/energybean_cores3/Battery/battery_Green_Charge.png"
                    if charging
                    else "/system/energybean_cores3/Battery/battery_Green.png"
                )
        else:
            src = (
                "/system/energybean_cores3/Battery/battery_Black_Charge.png"
                if charging
                else "/system/energybean_cores3/Battery/battery_Black.png"
            )
        return src
