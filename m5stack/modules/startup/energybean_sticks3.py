...
DEBUG = False
BATTERY_TEXT_COLOR = 0x000000
BATTERY_TEXT_COLOR_CHARGING = 0x00A000
BATTERY_TEXT_BG_COLOR = 0xCCCCCC


def _battery_text(with_percent=False):
    text = str(M5.Power.getBatteryLevel())
    return text + "%" if with_percent else text


CHARGE_ICON = "/system/energybean_sticks3/CHG.jpg"
NO_CHARGE_ICON = "/system/energybean_sticks3/noCHG.jpg"
CLOUD_ICON = "/system/energybean_sticks3/1a.jpg"
USB_ICON = "/system/energybean_sticks3/1b.jpg"
APPLIST_ICON = "/system/energybean_sticks3/1c.jpg"
LORACHAT_ICON = "/system/energybean_sticks3/1d.jpg"
SETUP_ICON = "/system/energybean_sticks3/1e.jpg"
USB_IMG = "/system/energybean_sticks3/usb.jpg"
APPLIST_IMG = "/system/energybean_sticks3/APPLIST.jpg"
CLOUD_IMG = "/system/energybean_sticks3/a11.jpg"
NG_IMG = "/system/energybean_sticks3/ng.jpg"
WIFI_OK_IMG = "/system/energybean_sticks3/wifi_ok.jpg"
SERVER_OK_IMG = "/system/energybean_sticks3/server_ok.jpg"
PLACEHOLDER_IMG = "/system/energybean_sticks3/placeholder.jpg"
STATE_WIFI_NO_SET_IMG = "/system/energybean_sticks3/wifiNeverSet.jpg"
STATE_WIFI_NG_IMG = "/system/energybean_sticks3/wifiNG.jpg"
STATE_WIFI_OK_IMG = "/system/energybean_sticks3/wifiOKServerNG.jpg"
STATE_SERVER_OK_IMG = "/system/energybean_sticks3/wifiOKServerOK.jpg"
SETUP_AP_IMG = "/system/energybean_sticks3/a1.jpg"
SETUP_WEB_IMG = "/system/energybean_sticks3/a2.jpg"
SETUP_WIFI_IMG = "/system/energybean_sticks3/a3.jpg"
SETUP_WIFI_NG_IMG = "/system/energybean_sticks3/a4.jpg"
SETUP_WIFI_OK_IMG = "/system/energybean_sticks3/a7.jpg"
SETUP_SERVER_NG_IMG = "/system/energybean_sticks3/a9.jpg"
SETUP_SERVER_OK_IMG = "/system/energybean_sticks3/a11.jpg"
...
class UsbApp(AppBase):
    ...
    async def on_run(self):
        while True:
            # battery
            self._battery_label.set_text_color(
                BATTERY_TEXT_COLOR_CHARGING if M5.Power.isCharging() else BATTERY_TEXT_COLOR,
                0xFFFFFF,
            )
            self._battery_label.set_text("%d%%" % M5.Power.getBatteryLevel())
...
class ListApp(AppBase):
    ...
    def on_view(self):
        ...
        # APPLIST.jpg has a static '%' mark at top-right; mask it after drawing.
        M5.Lcd.fillRect(78, 0, 57, 22, 0xFFFFFF)
        file_label_x = 23
        file_label_y = 105
...
class LauncherApp(AppBase):
    ...
    def on_view(self):
        ...
        # Cover right-side '%' printed in background image.
        M5.Lcd.fillRect(78, 0, 57, 26, BATTERY_TEXT_BG_COLOR)
        ...
        self._battery_label = widgets.Label(
            ...
            h=21,
            font_align=widgets.Label.RIGHT_ALIGNED,
            fg_color=BATTERY_TEXT_COLOR,
            bg_color=BATTERY_TEXT_BG_COLOR,
            font=M5.Lcd.FONTS.Montserrat18,
        )
        self._set_battery_text_style(M5.Power.isCharging())
        self._battery_label.set_text("%d%%" % M5.Power.getBatteryLevel())
    ...
    async def on_run(self):
        ...
        while True:
            ...
            if last_charging != M5.Power.isCharging():
                ...
                self._set_battery_text_style(last_charging)

            # battery level
            if last_battery != M5.Power.getBatteryLevel():
                last_battery = M5.Power.getBatteryLevel()
                self._battery_label.set_text("%d%%" % last_battery)
    ...
    def _set_battery_text_style(self, charging):
        color = BATTERY_TEXT_COLOR_CHARGING if charging else BATTERY_TEXT_COLOR
        self._battery_label.set_text_color(color, BATTERY_TEXT_BG_COLOR)
...
class StickS3_Startup:
    ...
    def startup(
        ...
        DEBUG and print("Run EnergyBean StickS3 list mode")

        list_app = ListApp()

        fw = Framework()
        fw.install_launcher(list_app)
        fw.install(list_app)
        fw.start()
